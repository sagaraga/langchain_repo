...
class Review(TypedDict):
    keypoints: Annotated[list[str], "give the keypoints discussed in the review"]
    reviewer: Annotated[Optional[str], "provide the name of the reviewer"]
    pros: Annotated[Optional[list[str]], " provide the positives in the form of list"]
    cons: Annotated[Optional[list[str]], " provide the negatives in the form of list"]
    sentiment: Annotated[
        Literal['positive', 'negative'], "give the sentiment of the review. either positive or negative"]
    data: Annotated[datetime, "provide the date of the review"]
